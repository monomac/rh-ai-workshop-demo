...
nb03 = [
    ...
    md(
        ...
        "",
        "Latence: cca 8-12 s na řádek na A10G **sériově**, ale `explain_queue`",
        "ve výchozím nastavení posílá až 5 in-flight requestů paralelně přes",
        "ThreadPoolExecutor -- vLLM 0.18 to bez problémů zvládá. **25 řádků",
        "doběhne za ~75-80 s místo 3-4 min.** `max_workers=N` v `explain_queue`",
        "to ladí. Pokud je endpoint nedostupný, funkce vrátí fallback hlášku",
        "a notebook pokračuje.",
    ),
    code(
